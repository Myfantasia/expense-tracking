...
const ICONS = {
    ...
    paypal: (
        <div className="w-12 h-12 bg-blue-800 text-white flex items-center justify-center rounded-full">
            <FaPaypal size={26}/>
        </div>
    ),
};
            ...
            <div className="w-full">
                {data?.map((item, index) => (
                    ...
                    >
                        ...
                        <div>
                            <p className="text-lg 2xl:text-xl text-black dark:text-gray-700 font-medium">
                                {formatCurrency(item?.account_balance)}
                            </p>
                            <span className="text-xs 3xl:text-sm text-gray-600 dark:text-violet-700">
                                Account Balance
                            </span>
                        </div>
                    </div>
